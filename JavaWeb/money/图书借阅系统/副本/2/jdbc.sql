...
-- Records of books
-- ----------------------------
INSERT INTO `books` VALUES (1, '深入理解计算机系统', '青岛出版社', 79, 18, '/upload/books/1.jpg', 1);
INSERT INTO `books` VALUES (2, '代码大全', '商务印书馆', 89, 55, '/upload/books/2.jpg', 1);
INSERT INTO `books` VALUES (3, '计算机网络', '江苏出版社', 69, 95, '/upload/books/3.jpg', 1);
INSERT INTO `books` VALUES (4, '折子戏研究', '中国友谊出版', 75, 88, '/upload/books/4.jpg', 2);
INSERT INTO `books` VALUES (5, '达达主义百年史', '技力出版社', 65, 20, '/upload/books/5.jpg', 2);
INSERT INTO `books` VALUES (6, '神来飞鸟引弦歌', '吉林人民出版社', 85, 55, '/upload/books/6.jpg', 2);
INSERT INTO `books` VALUES (7, '卓有成效的管理者', '中国出版', 72, 0, '/upload/books/7.jpg', 3);
INSERT INTO `books` VALUES (8, '成果管理', '中信出版社', 68, 62, '/upload/books/8.jpg', 3);
INSERT INTO `books` VALUES (9, '地图简史', '海南出版社', 78, 29, '/upload/books/9.jpg', 4);
INSERT INTO `books` VALUES (10, '创新的扩散', '清华大学出版社', 66, 40, '/upload/books/10.jpg', 5);
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (1, 1, 2, 1, 79.00, 2, '2024-01-05 10:00:00', '上海市徐汇区', '13922222222');
...
INSERT INTO `orders` VALUES (12, 3, 5, 1, 69.00, 1, '2024-01-09 15:40:00', '杭州市西湖区', '13955555555');
INSERT INTO `orders` VALUES (13, 5, 6, 2, 130.00, 1, '2024-01-09 16:55:00', '成都市武侯区', '13966666666');
INSERT INTO `orders` VALUES (14, 7, 7, 1, 72.00, 1, '2024-01-10 09:30:00', '南京市鼓楼区', '13977777766');
INSERT INTO `orders` VALUES (15, 1, 2, 1, 79.00, 0, '2025-01-10 02:38:40', '上海市徐汇区', '13922222222');
INSERT INTO `orders` VALUES (17, 8, 3, 1, 68.00, 0, '2025-01-10 04:17:07', '广州市番禺区', '13933333333');
INSERT INTO `orders` VALUES (18, 1, 3, 1, 79.00, 0, '2025-01-10 04:21:40', '广州市番禺区', '13933333333');
INSERT INTO `orders` VALUES (19, 7, 3, 1, 72.00, 0, '2025-01-10 04:26:55', '广州市番禺区', '13933333333');
INSERT INTO `orders` VALUES (20, 8, 3, 1, 68.00, 0, '2025-01-10 04:28:57', '广州市番禺区', '13933333333');
INSERT INTO `orders` VALUES (21, 7, 4, 1, 72.00, 0, '2025-01-10 04:36:17', '深圳市罗湖区', '13944444444');
INSERT INTO `orders` VALUES (22, 3, 4, 1, 69.00, 0, '2025-01-10 04:38:42', '深圳市罗湖区', '13944444444');
...
INSERT INTO `users` VALUES (2, 'cm', '123456', 'chenming@example.com', '1995-03-15', 0, 'null', 'null');
...
INSERT INTO `users` VALUES (5, 'zhagnwei', '123456', 'zhangwei@example.com', '1996-11-18', 0, 'null', 'null');
INSERT INTO `users` VALUES (6, 'linjing', '123456', 'linjing@example.com', '1993-07-10', 0, '成都市武侯区', '13966666666');
INSERT INTO `users` VALUES (7, 'hhhh', '123456', 'huangxiao@example.com', '1998-04-22', 0, 'null', 'null');
INSERT INTO `users` VALUES (8, 'zhoujie', '123456', 'zhoujie@exampl', '1992-09-30', 0, 'null', 'null');
